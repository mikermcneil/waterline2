...
function ORM (opts) {
  ...
  // Ensure everything in the ontology is new-ed up appropriately
  this.adapters = constructAll(this.adapters, Adapter);
  this.databases = constructAll(this.databases, Database);
  this.models = constructAll(this.models, Model);
 ...
 * @api private
 */
function constructAll(set, Class) {
