...
var buildAR = require('../build-association-rule');
...
module.exports = function refresh () {
  ...
  // console.log('\n\n');
  // console.log('************************');
  // console.log('Building ARs again...');
  // console.log('************************');
  ...
  // console.log('\n\n');
  // console.log('************************');
  // console.log('Refreshing ARs again...');
  // console.log('************************');
