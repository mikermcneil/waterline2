...
/**
 * Refresh this model's datastore, adapter, associations and related
 * metadata (i.e. keys/junctions/associated models) as well as any other
 * future configuration.  Should be run on participating models whenever
