...
module.exports = function getAssociationRule (attrName) {
  ...
  var rule = {
    ...
    /**
     * Build a criteria tree to use as the new parent criteria tree
     ...
     * @nosideeffects
     */
    getCriteria: function (parentResults, originalChildCriteria, originalQuery) {
     ...
     * for the child cursor when all grandchild associations are finished.  That
     ...
     * @hotcodepath
     */
    getWhoseFilter: function (parentResults, originalChildCriteria, originalQuery) {

      /**
       * @param  {Object[]} childResults
       * @return {Object[]} subset of `childResults`
       */
      return function _whoseFilter (childResults){
     ...
     * (i.e. within the child cursor, the logic that compares `filteredBatchResults`
     * against the subset of results received from *ITS* recursive call for a particular
     * association ("grandchild" results, if you will)
     *
     * Should return a subset of `childResults`.
     *
     * TODO:
     * This fn is not currently called out to by the criteria cursor, but it probably
     * needs to be.
     *
     * @polyfill {Relational}
     * @nosideeffects
     * @hotcodepath
     */
    getBubbleFilter: function (filteredParentResults, originalChildCriteria, originalQuery) {

      /**
       * @param  {Object[]} childResults
       * @param  {Object[]} grandchildResults
       * @return {Object[]} a subset of `childResults`
       */
      return function _bubbleFilter (childResults, grandchildResults) {
        // TODO: actually do something
        return childResults;
      };
    },
