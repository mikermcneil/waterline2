  ...
  return function _rewriteArgument (memo, adapterUsageArg, i) {
    ...
    switch (adapterUsageArg) {
      ...
      case 'criteria':
        ...
        // (since it would appear `updatedAt` sometimes goes missing-- and possibly other issues)
        // Unclear whether this is an issue in WL1 or WL2, but it is easily worked around for
        // the short-term by making the choice to...
