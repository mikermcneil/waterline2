 ...
 //  }
  ...
  function whenDoneWithAllBatches (err) {
    ...
    .exec(function (err, results) {
      ...
      //
      // If this is the root cursor, we can just push them all to the buffer
      // identified by `qpath` (i.e. "root")
      if (!previous) {
        heap.push(qpath, results);
      }
      else {
