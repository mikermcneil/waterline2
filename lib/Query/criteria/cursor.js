    ...
    src.find({
      ...
      where: (function _topFootprintWHEREClause () {
        ...
        where[src.primaryKey] = (function _topFootprintPKValues() {
          ...
          // console.log('Preparing to hydrate footprints for `'+src.identity+'`. Local heap has:',util.inspect(footprints,false,null));
          ...
          // console.log('some in-memory filtering happened.. and reduced local heap to:',util.inspect(footprints,false,null));
          return footprints;
        })();
        return where;
      })(),
