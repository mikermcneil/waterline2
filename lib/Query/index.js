...
function Query (opts, worker) {
  ...
  // (assuming the orm instance was passed in the opts)
  if (opts.orm) {
  ...
  Query.super_.apply(this, [opts, function do_exec (cb) {
    ...
    var defaultSelect = _.mapValues(model.attributes, function () {return true;});
...
Query.prototype.inspect = function () {
  return prettyInstance(this, this._opts.operations);
};
