        ...
        // (or use optimized approach, i.e. call `.join()` in the adapter)
          ...
          async.each(Object.keys(joins), function (attrName, next_subop) {
            ...
            if (attrDef.model) {
              ...
              var fkValues = _.pluck(filteredBatchResults, attrName);
            ...
            // N.1
              ...
              subop.where[foreignKey] = _.pluck(filteredBatchResults, primaryKey);
            ...
            function doRecursiveStep (subop, doRecursiveStep_cb) {
              ...
              runOperation(subop, function (err, subopResults) {
                ...
                if (
                  ...
                  var originalResultIds = _.pluck(subopResults,assoc.primaryKey);
                  // console.log('assoc.primaryKey:', assoc.primaryKey);
                  ...
                  var filteredSubopResultIds = _.pluck(filteredSubopResults, assoc.primaryKey);
