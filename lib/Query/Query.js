...
function Query (opts, _adapterWorker) {
  ...
  console.log('AFTER',require('util').inspect(opts.operations, false, null));
  ...
  // console.log('Built query w/ WHERE Clause:', require('util').inspect(this.operations.where, false, null));
