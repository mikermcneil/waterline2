...
function Query (opts, _adapterWorker) {
  ...
  if (typeof opts.operations === 'undefined') {
    opts.operations = {
      ...
      // internally.  This keeps the physical-layer schema out of app code.
      joins: opts.joins
    };
  }
  ...
  opts.operations = normalizeOperationsTree(opts.operations, targetModel, flags);
