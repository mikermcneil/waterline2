...
var normalizeCriteria = require('./criteria/syntax/normalize-criteria');
...
function Query (opts, _adapterWorker) {
  ...
  opts.criteria = normalizeCriteria(opts.criteria, targetModel, criteriaMetadata);
 ...
 */
Query.prototype.parseResults = require('./engine/parse-results');
