...
module.exports = function engine (operationsTree, parentQuery, cb) {
  ...
  return runOperation(operationsTree, cb);
        ...
        // (or use optimized approach, i.e. call `.join()` in the adapter)
          ...
          async.each(Object.keys(joins), function (attrName, next_subop) {
            ...
            if (assoc.type === '1-->N') {
              ...
              inValues = _.pluck(filteredBatchResults, assoc.foreignKeys[modelIdentity]);
              ...
              subop.where[assoc.foreignKeys[subop.from]] = inValues;
            ...
            function doRecursiveStep (subop, doRecursiveStep_cb) {
              ...
              runOperation(subop, function (err, subopResults) {
                ...
                if (
                  ...
                  var originalResultIds = _.pluck(subopResults,assoc.target.primaryKey);
