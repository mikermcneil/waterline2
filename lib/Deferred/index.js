...
module.exports = function (config) {
  ...
  function Deferred (opts, deferred_callback) {
    ...
    if (config.Promise) {
      ...
      //
      // TODO:
      // at some point, try to go the other way, i.e extend `this` and then return it,
      // instead of extending a Promise and returning that.  For instance:
      // ```
      // _.extend(this, new Promise(...));
      // return this;
      // ```
      //
