...
module.exports = {
  ...
  refresh: function () {
    ...
    // TODO:
    // Allow the `fieldName` for both of the FKs and
    // the `cid` of the Junction itself to be configured.
    var junctionIdent = 'foo';
    var foreignKeyToParentFieldName = '_foo_to_x';
    var foreignKeyToChildFieldName  = '_foo_to_y';
      ...
      orm.junction(junctionIdent, {
        ...
        attributes: {
          ...
          x: {
            ...
            fieldName: foreignKeyToParentFieldName
          },
          ...
          y: {
            ...
            fieldName: foreignKeyToChildFieldName
          }
        }
      });
    }
