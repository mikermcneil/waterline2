...
module.exports = {
   ...
   * @return {Function}
   */
  getChildFilter: function(filteredParentBatchResults, originalChildCriteria, parentCriteria) {
  ...
  /**
   * Return a function which will be used to filter each batch parent results
