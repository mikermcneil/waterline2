...
// Semantics
Relation.prototype.query = require('./query');
Relation.prototype.transaction = require('./transaction');
Relation.prototype.bootstrap = require('./bootstrap');
Relation.prototype.refresh = require('./refresh');
