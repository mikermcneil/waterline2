    ...
    // `collection` --> `association: { plural: true, entity: 'model', identity: '...' }`
      ...
      attrDef.association = _.defaultsDeep(attrDef.association||{}, {
        ...
        rule: (function _getAppropriateDefaultARKey () {
          ...
          if (_(orm.models).any(function _haveModelAttrPointingAtUs (model){
            return _(model.attributes).any(function (attrDef, attrName){
              return attrDef.model && (attrDef.model.toLowerCase() === identity);
            });
          })) {
            return 'viaFk';
          }
